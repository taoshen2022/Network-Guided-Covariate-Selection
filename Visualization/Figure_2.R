load("./Visualization/Sina-left.Rdata")
load("./Visualization/Sina-right.Rdata")

pdf("sina_covs.pdf", width = 14, height = 6)  
kseq <- 1:50
pseq_sina <- seq(1, 39, 2)

par(mfrow = c(1,2), mar = c(5, 4, 4, 8),                                 
    xpd = TRUE)
