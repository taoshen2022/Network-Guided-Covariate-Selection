...
Time_record = matrix(0, nrow = repetition, ncol = 6) #store the true positives
...
for(ii in 1:repetition){
  ...
  save(signals, pval.fs, pval.fsl, pval.chi, fsca.vx, sk.vx, pval.label, file = filename)
  #fsca.vx, sk.vx
  print(paste("rep = ", ii));
}


## Record positives and true positives
pseq = seq(10,500, by = 5); 
...
save(pseq, TP3, file = "fig1-right-dcsbm.Rdata")
